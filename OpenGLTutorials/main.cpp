...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		depthShader.use();
		for (unsigned int i = 0; i < 6; ++i)
			depthShader.set("shadowMatrices[" + std::to_string(i) + "]", shadowTransforms[i]);

		depthShader.set("far_plane", far_plane);
		depthShader.set("lightPos", lightPos);
