// EXERCISE 1.2: Expermiten with the different texture wrapping methos by specifying texture
// coordinates in the range 0.0f to 2.0f to display 4 faces clamped to container edge
